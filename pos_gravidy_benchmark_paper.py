...
def plot_paper_results(all_results, stats, problem, x_star, f_star):
    ...
    plt.title('Orthant (NNLS): Final KKT Residuals (10 trials)', fontweight='bold')
    ...
    plt.tight_layout()
    plt.savefig("figs/pos_final_kkt.pdf", bbox_inches="tight")
    plt.show()
...
if __name__ == "__main__":
    ...
    all_results, stats, problem, x_star, f_star = run_multi_seed_benchmark(
        n=120, m=120, density=0.15, eta=10.0, max_iters=400, 
